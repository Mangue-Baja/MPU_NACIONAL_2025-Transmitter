...
void bluetooth_debug(){
  ...
  */
  ...
  SerialBT.print("Checagem do dispositivo SD = ");      if(bluetooth_packet.check_sd == 2)               SerialBT.println("OK");         else if(bluetooth_packet.check_sd == 1)                    SerialBT.println("ERRO");     else SerialBT.println("NO INFO");
  SerialBT.println("--------------------------------FRONT--------------------------------");
  SerialBT.print("Inicialização do acelerômetro = ");   if(bluetooth_packet.accel_begin == 2)            SerialBT.println("OK");         else if(bluetooth_packet.accel_begin == 1)                 SerialBT.println("ERRO");     else SerialBT.println("NO INFO");
  SerialBT.println("--------------------------------REAR--------------------------------");
  SerialBT.print("DDP do termistor = ");                if(bluetooth_packet.termistor == 2)              SerialBT.println("OK");         else if(bluetooth_packet.termistor == 1)                   SerialBT.println("ERRO");     else SerialBT.println("NO INFO");
  SerialBT.print("Temperatura da CVT = ");              if(bluetooth_packet.cvt_temperature == 2)        SerialBT.println("OK");         else if(bluetooth_packet.cvt_temperature == 1)             SerialBT.println("ERRO");     else SerialBT.println("NO INFO");
  SerialBT.print("Medida da DDP = ");                   if(bluetooth_packet.measure_volt == 2)           SerialBT.println("OK");         else if(bluetooth_packet.measure_volt == 1)                SerialBT.println("ERRO");     else SerialBT.println("NO INFO");
  SerialBT.print("Contador de pulso da velocidade = "); if(bluetooth_packet.speed_pulse_counter == 2)    SerialBT.println("OK");         else if(bluetooth_packet.speed_pulse_counter == 1)         SerialBT.println("ERRO");     else SerialBT.println("NO INFO");
  SerialBT.print("Estado do servo = ");                 if(bluetooth_packet.servo_state == 4)            SerialBT.println("CHOKE MODE"); else if(bluetooth_packet.servo_state == 3) SerialBT.println("MID MODE"); else if(bluetooth_packet.servo_state == 2) SerialBT.println("RUN MODE"); else if(bluetooth_packet.servo_state == 1) SerialBT.println("ERRO"); else SerialBT.println("NO INFO");
}
